...
if (isset($_SESSION['userPass']) && isset($_SESSION['userId'])) {
    ...
    if (isset($_GET['search'])) {
        ...
        $sqll = "SELECT * FROM Drug_E_Dispensing.prescriptions WHERE userId=$_SESSION[userId] AND (presId LIKE '%$search%' OR Date LIKE '%$search%')";
    } else {
        // Default query without search condition
        $sqll = "SELECT * FROM Drug_E_Dispensing.prescriptions WHERE userId=$_SESSION[userId]";
    }
...
<body>
    <form method="GET" action="">
        <input type="text" name="search" placeholder="Prescription ID or Date ">
    ...
    <table>
        ...
        <tr>
            ...
            <td><a href="orderpatientprescrption.php?presId=<?php echo $row['presId']; ?>"><button>ORDER</button></a></td>
        </tr>
        <?php
        }
        ?>
